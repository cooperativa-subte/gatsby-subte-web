      ...
      <StyledNosotresPageContainer>
        <div className='desktop-container'>
          <section className='row'>
            ...
            <div>
              <p>
                Somos una cooperativa de trabajo enfocada en la comunicación,
                con una perspectiva popular y colaborativa. Trabajamos con
                organizaciones sociales, culturales, sindicatos, cooperativas y
                emprendimientos.
              </p>
              <p>
                Tenemos la convicción de que la construcción de alternativas que
                aporten a transformaciones sociales se da en el plano económico,
                político y cultural, pero también en el simbólico y estético.
                Conformamos este espacio para trabajar y reflexionar articulando
                estas dimensiones.
              </p>
            </div>
          </section>
          ...
          <section className='row'>
            ...
            <p>
              Subte es una cooperativa que busca crecer practicando la
              intercooperación. Estos son los proyectos con los que venimos
              alcanzando acuerdos de trabajo conjunto.
            </p>
          </section>
          <section className='row-5 proyectos-aliados-logos-container'>
            ...
            />
            <img src={PedalLogo} alt='Logo de Pedal' />
            <img
              src={ComunaLogo}
            ...
            <img
              src={CICLogo}
              alt='Logo de Cooperativa Integral Consultora (CIC)'
            />
          </section>
        </div>
      </StyledNosotresPageContainer>
